...
PITY_RATES = {
    RARITY_SSS: 2.9,   # 保底时000概率2.9%
    RARITY_SS: 94.5,   # 保底时00概獸94.5%
}
...
IDENTITIES = [
    ...
    {"name": "Seven协会南部6科", "sinner": "李箱", "rarity": RARITY_SSS, "image": "Yi_Sang/Yi_Sang-Seven.jpg"},
    {"name": "N公司E.G.O:凶弹", "sinner": "李箱", "rarity": RARITY_SSS, "image": "Yi_Sang/Yi_Sang-N.webp"},
    {"name": "LCE E.G.O:提灯", "sinner": "李箱", "rarity": RARITY_SSS, "image": "Yi_Sang/Yi_Sang-LCE.webp"},
    {"name": "LCB罪人", "sinner": "李箱", "rarity": RARITY_SSS, "image": "Yi_Sang/Yi_Sang-LCB.jpg"},
    {"name": "Dieci协会南部4科", "sinner": "李箱", "rarity": RARITY_SSS, "image": "Yi_Sang/Yi_Sang-Dieci.webp"},
    {"name": "绽放E.G.O:山茶花", "sinner": "李箱", "rarity": RARITY_SSS, "image": "Yi_Sang/Yi_Sang-hua_xiang.webp"},
    {"name": "裴廓德号大副", "sinner": "李箱", "rarity": RARITY_SSS, "image": "Yi_Sang/Yi_Sang-da_fu.webp"},
    ...
    {"name": "臼齿事务所收尾人", "sinner": "李箱", "rarity": RARITY_SSS, "image": "Yi_Sang/Yi_Sang-jiu_chi.webp"},
    ...
    {"name": "Zwei协会南部4科", "sinner": "浮士德", "rarity": RARITY_SSS, "image": "Faust/Faust-Zwei.webp"},
    {"name": "W公司2级清扫人员", "sinner": "浮士德", "rarity": RARITY_SSS, "image": "Faust/Faust-W.webp"},
    ...
    {"name": "LCB罪人", "sinner": "浮士德", "rarity": RARITY_SSS, "image": "Faust/Faust-LCB.jpg"},
    ...
    {"name": "脑叶公司幸存者", "sinner": "浮士德", "rarity": RARITY_SSS, "image": "Faust/Faust-L2.webp"},
    {"name": "剑契组杀手", "sinner": "浮士德", "rarity": RARITY_SSS, "image": "Faust/Faust-jian_qi.webp"},
    {"name": "呼啸山庄管家", "sinner": "浮士德", "rarity": RARITY_SSS, "image": "Faust/Faust-guan_jia.webp"},
    ...
    # === 堂吉诃德 (Don Quixote) ===
    {"name": "し协会南部5科科长", "sinner": "堂吉诃德", "rarity": RARITY_SSS, "image": "Don_Quixote/Don_Quixote-し.webp"},
    ...
    {"name": "N公司中锤", "sinner": "堂吉诃德", "rarity": RARITY_SSS, "image": "Don_Quixote/Don_Quixote-N.webp"},
    {"name": "LCB罪人", "sinner": "堂吉诃德", "rarity": RARITY_SSS, "image": "Don_Quixote/Don_Quixote-LCB.jpg"},
    ...
    {"name": "脑叶公司E.G.O:提灯", "sinner": "堂吉诃德", "rarity": RARITY_SSS, "image": "Don_Quixote/Don_Quixote-L.webp"},
    {"name": "拉·曼却领总督", "sinner": "堂吉诃德", "rarity": RARITY_SSS, "image": "Don_Quixote/Don_Quixote-xue_tang.webp"},
    {"name": "剑契组杀手", "sinner": "堂吉诃德", "rarity": RARITY_SSS, "image": "Don_Quixote/Don_Quixote-jian_qi.webp"},
    ...
    {"name": "Seven协会南部6科", "sinner": "良秀", "rarity": RARITY_SSS, "image": "Ryoshu/Ryoshu-Seven.webp"},
    {"name": "N公司E.G.O:轻蔑，敬畏", "sinner": "良秀", "rarity": RARITY_SSS, "image": "Ryoshu/Ryoshu-N.webp"},
    {"name": "LCCB系长", "sinner": "良秀", "rarity": RARITY_SSS, "image": "Ryoshu/Ryoshu-LCCB.webp"},
    {"name": "LCB罪人", "sinner": "良秀", "rarity": RARITY_SSS, "image": "Ryoshu/Ryoshu-LCB.jpg"},
    {"name": "脑叶公司E.G.O:赤瞳·忏悔", "sinner": "良秀", "rarity": RARITY_SSS, "image": "Ryoshu/Ryoshu-L.webp"},
    {"name": "六协会南部4科", "sinner": "良秀", "rarity": RARITY_SSS, "image": "Ryoshu/Ryoshu-6.webp"},
    ...
    {"name": "20区圣愚", "sinner": "良秀", "rarity": RARITY_SSS, "image": "Ryoshu/Ryoshu-sheng_yv.webp"},
    ...
    {"name": "LCB罪人", "sinner": "默尔索", "rarity": RARITY_SSS, "image": "Meursault/Meursault-LCB.jpg"},
    ...
    {"name": "中指幼弟", "sinner": "默尔索", "rarity": RARITY_SSS, "image": "Meursault/Meursault-zhong_zhi.webp"},
    {"name": "死兔帮老大", "sinner": "默尔索", "rarity": RARITY_SSS, "image": "Meursault/Meursault-si_tu.webp"},
    {"name": "拇指东部指挥官IIII", "sinner": "默尔索", "rarity": RARITY_SSS, "image": "Meursault/Meursault-lei_heng.webp"},
    {"name": "玫瑰扳手工坊收尾人", "sinner": "默尔索", "rarity": RARITY_SSS, "image": "Meursault/Meursault-mei_gui.webp"},
    {"name": "六协会南部6科", "sinner": "默尔索", "rarity": RARITY_SSS, "image": "Meursault/Meursault-6.webp"},
    ...
    # === 鸿璐 (Hong Lu) ===
    {"name": "W公司2级清扫人员", "sinner": "鸿璐", "rarity": RARITY_SSS, "image": "Hong_Lu/Hong_Lu-W.webp"},
    {"name": "R公司第四集团军驯鹿队", "sinner": "鸿璐", "rarity": RARITY_SSS, "image": "Hong_Lu/Hong_Lu-R.webp"},
    {"name": "LCB罪人", "sinner": "鸿璐", "rarity": RARITY_SSS, "image": "Hong_Lu/Hong_Lu-LCB.jpg"},
    ...
    {"name": "六协会南部5科", "sinner": "鸿璐", "rarity": RARITY_SSS, "image": "Hong_Lu/Hong_Lu-6.webp"},
    {"name": "猎牙事务所收尾人", "sinner": "鸿璐", "rarity": RARITY_SSS, "image": "Hong_Lu/Hong_Lu-lie_ya.webp"},
    ...
    {"name": "黑云会若众", "sinner": "鸿璐", "rarity": RARITY_SSS, "image": "Hong_Lu/Hong_Lu-hei_yun.webp"},
    {"name": "豆豆帮帮主", "sinner": "鸿璐", "rarity": RARITY_SSS, "image": "Hong_Lu/Hong_Lu-dou_dou.webp"},
    {"name": "吊钩事务所收尾人", "sinner": "鸿璐", "rarity": RARITY_SSS, "image": "Hong_Lu/Hong_Lu-diao_gou.webp"},
    {"name": "20区圣愚", "sinner": "鸿璐", "rarity": RARITY_SSS, "image": "Hong_Lu/Hong_Lu-sheng_yv.webp"},

    # === 希斯克利夫 (Heathcliff) ===
    {"name": "し协会南部5科", "sinner": "希斯克利夫", "rarity": RARITY_SSS, "image": "Heathcliff/Heathcliff-し.webp"},
    {"name": "W公司4级清扫人员-CCA", "sinner": "希斯克利夫", "rarity": RARITY_SSS, "image": "Heathcliff/Heathcliff-W.webp"},
    {"name": "Seven协会南部4科", "sinner": "希斯克利夫", "rarity": RARITY_SSS, "image": "Heathcliff/Heathcliff-Seven.webp"},
    ...
    {"name": "N公司小锤", "sinner": "希斯克利夫", "rarity": RARITY_SSS, "image": "Heathcliff/Heathcliff-N.webp"},
    {"name": "LCB罪人", "sinner": "希斯克利夫", "rarity": RARITY_SSS, "image": "Heathcliff/Heathcliff-LCB.jpg"},
    ...
    {"name": "多裂纹事务所收尾人", "sinner": "希斯克利夫", "rarity": RARITY_SSS, "image": "Heathcliff/Heathcliff-duo_liewen.webp"},

    # === 以实玛利 (Ishmael) ===
    {"name": "し协会南部5科", "sinner": "以实玛利", "rarity": RARITY_SSS, "image": "Ishmael/Ishmael-し.webp"},
    ...
    {"name": "LCCB系长", "sinner": "以实玛利", "rarity": RARITY_SSS, "image": "Ishmael/Ishmael-LCCB.webp"},
    {"name": "LCB罪人", "sinner": "以实玛利", "rarity": RARITY_SSS, "image": "Ishmael/Ishmael-LCB.jpg"},
    {"name": "裴廓德号船长", "sinner": "以实玛利", "rarity": RARITY_SSS, "image": "Ishmael/Ishmael-fei_dehao.webp"},
    {"name": "脑叶公司E.G.O:荡漾", "sinner": "以实玛利", "rarity": RARITY_SSS, "image": "Ishmael/Ishmael-dang_yang.webp"},
    ...
    {"name": "埃德加家族管家", "sinner": "以实玛利", "rarity": RARITY_SSS, "image": "Ishmael/Ishmael-ai_dejia.webp"},

    # === 罗佳 (Rodion) ===
    {"name": "Девять协会北部3科", "sinner": "罗佳", "rarity": RARITY_SSS, "image": "Rodion/Rodion-Девять.webp"},
    {"name": "Zwei协会南部5科", "sinner": "罗佳", "rarity": RARITY_SSS, "image": "Rodion/Rodion-Zwei.webp"},
    {"name": "T公司2级征收人员", "sinner": "罗佳", "rarity": RARITY_SSS, "image": "Rodion/Rodion-T.webp"},
    {"name": "N公司中锤", "sinner": "罗佳", "rarity": RARITY_SSS, "image": "Rodion/Rodion-N.webp"},
    {"name": "LCCB系长", "sinner": "罗佳", "rarity": RARITY_SSS, "image": "Rodion/Rodion-LCCB.webp"},
    {"name": "LCB罪人", "sinner": "罗佳", "rarity": RARITY_SSS, "image": "Rodion/Rodion-LCB.jpg"},
    ...
    {"name": "Zwei协会西部3科", "sinner": "辛克莱", "rarity": RARITY_SSS, "image": "Sinclair/Sinclair-Zwei.webp"},
    {"name": "Zwei协会南部6科", "sinner": "辛克莱", "rarity": RARITY_SSS, "image": "Sinclair/Sinclair-Zwei2.webp"},
    {"name": "LCB罪人", "sinner": "辛克莱", "rarity": RARITY_SSS, "image": "Sinclair/Sinclair-LCB.jpg"},
    ...
    {"name": "脑叶公司E.G.O:朱符", "sinner": "辛克莱", "rarity": RARITY_SSS, "image": "Sinclair/Sinclair-zhu_fu.webp"},
    {"name": "拇指东部士兵II", "sinner": "辛克莱", "rarity": RARITY_SSS, "image": "Sinclair/Sinclair-mu_zhi.webp"},
    {"name": "流浪乐队头目", "sinner": "辛克莱", "rarity": RARITY_SSS, "image": "Sinclair/Sinclair-sha_chui.webp"},
    {"name": "黎明事务所收尾人", "sinner": "辛克莱", "rarity": RARITY_SSS, "image": "Sinclair/Sinclair-lin_ming.webp"},
    {"name": "臼齿修船厂收尾人", "sinner": "辛克莱", "rarity": RARITY_SSS, "image": "Sinclair/Sinclair-jiu_chi.webp"},
    ...
    {"name": "LCB罪人", "sinner": "格里高尔", "rarity": RARITY_SSS, "image": "Gregor/Gregor-LCB.jpg"},
    ...
    {"name": "玫瑰扳手工坊收尾人", "sinner": "格里高尔", "rarity": RARITY_SSS, "image": "Gregor/Gregor-mei_gui.webp"},
    {"name": "六协会南部6科", "sinner": "格里高尔", "rarity": RARITY_SSS, "image": "Gregor/Gregor-6.webp"},
    {"name": "良·派帮厨", "sinner": "格里高尔", "rarity": RARITY_SSS, "image": "Gregor/Gregor-liang.webp"},
    {"name": "拉·曼却领神父", "sinner": "格里高尔", "rarity": RARITY_SSS, "image": "Gregor/Gregor-la_manque.webp"},
    {"name": "黑云会副会长", "sinner": "格里高尔", "rarity": RARITY_SSS, "image": "Gregor/Gregor-hei_yun.webp"},
    ...
    {"name": "LCB罪人", "sinner": "奥提斯", "rarity": RARITY_SSS, "image": "Outis/Outis-LCB.jpg"},
    {"name": "G公司部长", "sinner": "奥提斯", "rarity": RARITY_SSS, "image": "Outis/Outis-G.webp"},
    {"name": "Cinq协会南部4科", "sinner": "奥提斯", "rarity": RARITY_SSS, "image": "Outis/Outis-Cinq.webp"},
    ...
    {"name": "剑契组杀手", "sinner": "奥提斯", "rarity": RARITY_SSS, "image": "Outis/Outis-jian_qi.webp"},
    {"name": "环指点彩派学徒", "sinner": "奥提斯", "rarity": RARITY_SSS, "image": "Outis/Outis-huan_zhi.webp"},
